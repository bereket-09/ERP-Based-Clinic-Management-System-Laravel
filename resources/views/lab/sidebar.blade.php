    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="/view_lab_order"><i class="fa fa-stethoscope"></i> <span> Lab Tests </span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="/view_lab_order">Ordered Tests</a></li>
                        <li><a href="/view_pending_lab_results">waiting for Samples</a></li>
