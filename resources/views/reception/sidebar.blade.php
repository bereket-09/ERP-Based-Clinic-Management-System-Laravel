    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="/queued_patients"><i class="fa fa-stethoscope"></i> <span> Patients </span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="/queued_patients">Queued Patients</a></li>
                        <li><a href="/all_patients">All Paitents</a></li>
                        {{-- <li><a href="#">Completed Treatement</a></li> --}}
                ...
                <li><a href="/labratorist"><i class="fa fa-user-o"></i> Labratorists </a></li>
                <li><a href="/pharmacist"><i class="fa fa-user-o"></i>Pharmacists</a></li>
                {{-- <li>
