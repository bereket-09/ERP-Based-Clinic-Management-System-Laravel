                    ...
                    <div class="col-12 col-md-2 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="/queued_patients" class="text-muted">View Queued Patients</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-2 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="pending_patients" class="text-muted">View Pending Patients</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-2 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="completed_visits" class="text-muted">View Completed Treatment Patients</a>
                            </div>
                        </div>
                    </div>
                </center>
