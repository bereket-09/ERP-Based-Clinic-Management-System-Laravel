            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h1 class="page-title">Queued Patients</h1>
                    </div>
                            ...
                            <table class="table table-border table-striped custom-table datatable mb-0" name="myTables"
                                ...
                                <tbody>
                                    @foreach ($visit as $visits)
                                        <tr>
                                            @if (Auth::user()->role == '1')
                                                @if ($visits->statues == 'Queued' || $visits->statues == 'Lab Result Completed')
                                                    @foreach ($patient as $patients)
                                                        @if ($patients->id == $visits->p_id && Auth::user()->id == $visits->doc_id)
                                                            ...
                                                            <td>
                                                                @if ($visits->statues == 'Queued')
                                                                    <span class="custom-badge status-orange">
                                                                        {{ $visits->statues }}

                                                                    </span>
                                                                @elseif ($visits->statues == 'Lab Result Completed')
