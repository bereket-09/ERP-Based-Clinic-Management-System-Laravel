            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">MY WORK LEAVE REQUESTS List</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{ url('/request-leave') }}" class="btn btn-primary float-right btn-rounded"><i
                                class="fa fa-plus"></i> New WorkLeave Request</a>
                    </div>
                </div>
