    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="/view_orderd_drugs"><i class="fa fa-hospital-o"></i> <span> Ordered Medicines </span> <span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="/view_orderd_drugs">Ordered Drugs </a></li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <li><a href="/view_outstock_drugs">OutStock DRUGS</a></li>
                        <li><a href="/view_expired_drugs">Expiring DRUGS</a></li>
                        <li><a href="/view_all_drugs">All Drugs Recored</a></li>
