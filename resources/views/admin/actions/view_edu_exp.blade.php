            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h1 class="page-title">Education Experiance Of Employees</h1>
                    </div>
                    <br> <br> <br>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <br> <br> <br>
                        <a href="{{ url('/add-edu-exp') }}" class="btn btn-primary float-right btn-rounded"><i
                                class="fa fa-plus"></i> Add new Education Experiance</a>
                    </div>
                </div>
