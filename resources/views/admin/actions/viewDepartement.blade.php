            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Departements List</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        @if (Auth::user()->role == '4')
                            <a href="{{ url('/add-departement') }}" class="btn btn-primary float-right btn-rounded"><i
                                    class="fa fa-plus"></i> Add Departement</a>
                        @endif
                    </div>
                </div>
                                                    ...
                                                    <div class="dropdown dropdown-action" width="50">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown dropdown-item"
                                                                href="{{ url('/edit-departement', $data->id) }}"><i
                                                                    class="fa fa-pencil m-r-5"></i> Edit</a>


                                                            <a href="{{ url('/delete_departement', $data->id) }}"
                                                                onclick="return confirm('Are you Sure you want to delete this Departement --({{ $data->name }})--  ??' )"
