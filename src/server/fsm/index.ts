...
export { appointmentMachine, type AppointmentEvent } from "./machines/appointment";
export { invoiceMachine, type InvoiceEvent } from "./machines/invoice";
...
import { appointmentMachine } from "./machines/appointment";
